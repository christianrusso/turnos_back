    ...
    public class HairdressingAppointmentController : Controller
    {
        ...
        public void RequestAppointmentForNonClient([FromBody] RequestHairdressingAppointmentForNonClientDto requestAppointmentDto)
        {
            ...
            using (var dbContext = new ApplicationDbContext())
            {
                ...
                try
                {
                    new MailAddress(requestAppointmentDto.Username);
                    email = requestAppointmentDto.Username;
                    phone = "11111111";
                }
                catch
                {
                    phone = requestAppointmentDto.Username;
                    email = phone +"@autogenerated.com";
                }

                var user = new ApplicationUser
                {
                    UserName = requestAppointmentDto.Username,
                    Email = email,
                    PhoneNumber = phone
                };
                ...
                emailMessage = new EmailDto
                {
                    ...
                    //ojo aca
                    To = new List<string> { hairdressing.User.Email, requestAppointmentDto.Username },
                    Message = template
                };
            }
