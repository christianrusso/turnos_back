...
{
    public class ClientServiceHairdressing : ClientServiceBase
    {
        public ClientServiceHairdressing(UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager, SignInManager<ApplicationUser> signInManager, IConfiguration configuration, HttpContext httpContext)
        ...
        public List<ClientDto> GetAllNonPatients()
        {
            using (var dbContext = new ApplicationDbContext())
            {
                ...
                return dbContext.Hairdressing_Clients
